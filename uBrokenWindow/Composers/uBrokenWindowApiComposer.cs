...
namespace uBrokenWindow.Composers
{
    public class uBrokenWindowApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            builder.AddNotificationAsyncHandler<UmbracoApplicationStartedNotification, BrokenWindowStartupHandler>();
            ...
            //     {
            //         Title = "uBroken Window Backoffice API",
            //         Version = "1.0",
            ...
            //     opt.OperationFilter<uBrokenWindowOperationSecurityFilter>();
            // });
        }

        // public class uBrokenWindowOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        // {
        ...
        //     {
        //         return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("uBrokenWindow.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
        //     }
        //
